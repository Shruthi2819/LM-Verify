...
function CertificateList() {
  ...
  const handleRowClick = (row) => {
    // Navigate to the business details page mapped to this certificate
  ...
  return (
    <div className="space-y-6 page-enter">
      <Breadcrumbs items={[{ label: "Dashboard", path: ROUTES.LMO_DASHBOARD }, { label: "Certificates" }]} />

      <div className="flex items-center gap-2">
        <Award className="text-blue-700" size={24} />
        <div>
          <h1 className="text-xl font-bold text-slate-800">Compliance Stamping Registry</h1>
          <p className="text-sm text-slate-500 mt-0.5">Directory of verification certificates within your jurisdiction</p>
        </div>
      </div>
      ...
      <Card noPadding>
        {loading ? (
          ...
          <Table
            ...
            emptyDescription="Stamping approvals will automatically generate certificates in this register."
          />
        )}
      </Card>
    </div>
